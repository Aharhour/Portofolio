...
const AddShows = () => {
    ...
    // Fetch currently playing movies from TMDB via our backend
    ...
    // Add a date+time entry to the selection map
    ...
    return nowPlayingMovies.length > 0 ? (
        <>
            ...
            {/* Movie selection carousel - non-hovered movies fade via group hover */}
