...
const SeatLayout = () => {
    // Seat rows grouped in pairs for the cinema layout
    ...
    // Handle seat toggle with validation (max 5 seats, no occupied seats)
    ...
    // Fetch which seats are already booked for the selected time slot
        ...
        <div className='flex flex-col md:flex-row px-6 md:px-16 lg:px-40 py-30 md:pt-50'>
            ...
            <div className='relative flex-1 flex flex-col items-center max-md:mt-16'>
                ...
                <div className='flex flex-col items-center mt-10 text-xs text-gray-300'>
                    {/* Front rows (A, B) in single column */}
