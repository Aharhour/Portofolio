...
// Inngest Function to cancel booking and release seats of show after 10 minutes of booking if the booking is not confirmed
    ...
    async ({event, step})=>{
        ...
        await sendEmail({
            ...
            body: ` <div style="font-family: Arial, sans-serif; line-height: 1.5;">
                        ...
                        <p>
                            <strong>Date:</strong> ${new Date(booking.show.showDateTime).toLocaleDateString('en-US', {timeZone:'Europe'})}<br/>
                            <strong>Time:</strong> ${new Date(booking.show.showDateTime).toLocaleDateString('en-US', {timeZone:'Europe'})}
                        </p>
                        <p>Enjoy the show!</p>
            ...
            return await Promise.allSettled(
                reminderTasks.map(task => sendEmail({
                    ...
                    body: ` <div style="font-family: Arial, sans-serif; padding:20px">
                                ...
                                <p>
                                    is scheduled for <strong>${new Date(task.showTime).toLocaleDateString('en-US', {timeZone: 'Europe'})}</strong> at
                                    <strong>${new Date(task.showTime).toLocaleString('en-US', {timeZone: 'Europe'})}</strong>
                                </p>
