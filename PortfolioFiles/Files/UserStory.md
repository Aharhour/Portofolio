...
## 👤 Algemene Gebruiker (Visitor)

### US-01 – Films bekijken
> 🔴 **Must Have** | ⏱️ Schatting: **4 uur**
...
- [ ] Gebruiker kan één of meerdere stoelen selecteren
- [ ] Selectie wordt visueel bevestigd vóór betaling
...
zodat ik er geen dubbele boekingen ontstaan.
...
zodat ik de verkoop correct wordt verwerkt op de achtergrond zonder de gebruiker te vertragen.
...
zodat ik alleen bevoegde gebruikers beheerrechten hebben.
...
zodat ik gebruikers nieuwe content kunnen boeken.
...
zodat ik de informatie actueel blijft.
...
zodat ik inzicht heb in de financiële prestaties.
...
> 🟡 **Could Have** | ⏱️ Schatting: **6 uur**

Als **gebruiker** wil ik dat de applicatie snel laadt,  
zodat ik mijn ervaring soepel verloopt.
